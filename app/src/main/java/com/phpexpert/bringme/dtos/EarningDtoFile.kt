...
class EarningDtoMain : BaseResponseDto() {
    @SerializedName("Total_Delivered_Orders")
    var Total_Delivered_Orders: String? = ""

    @SerializedName("Total_Delivered_Order_Amount")
    var Total_Delivered_Order_Amount: String? = ""

    @SerializedName("Total_Earned_Order_Amount")
    var Total_Earned_Order_Amount: String? = ""

    @SerializedName("Total_Cancelled_Orders")
    var Total_Cancelled_Orders: String? = ""

    @SerializedName("Total_Cancelled_Order_Amount")
    var Total_Cancelled_Order_Amount: String? = ""

    @SerializedName("data")
    var data: EarningDtoData? = EarningDtoData()
}

class EarningDtoData {
    @SerializedName("DeliveryEMPEarningList")
    var DeliveryEMPEarningList: ArrayList<EarningDtoList>? = ArrayList()
}

class EarningDtoList {
