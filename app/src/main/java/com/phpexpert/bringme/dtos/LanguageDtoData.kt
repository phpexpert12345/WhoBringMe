...
class LanguageDtoData {
    ...
    val title_2 = "Anywhere in Germany"
    ...
    val enter_password = "Enter 6 digit mPIN"
    val forgot_password = "Forgot mPIN?"
    val forgot_password_heading = "Forgot mPIN"
    val login = "Login"
    ...
    val verify = "Verify"
    val don_t_receive_code_resend_code = "Didn\'t Receive OTP?"
    val resend_code = "Resend OTP"
    val get_start = "Get Start"
    val there_are_no_job = "There is no job."
    ...
    val how_long_you_want_offer_this_job = "How long should you want to offer this job ?"
    val minute = "minutes"
    ...
    val otp_not_enter = "Enter OTP is required field."
    val enter_new_password = "Enter New mPIN"
    val enter_new_password_error = "Enter New mPIN is required field."
    val enter_6_digit_password = "Please enter 6 digit mPIN"
    val enter_confirm_password = "Enter Confirm mPIN"
    val enter_confirm_password_error = "Enter Confirm mPIN is required field."
    val _enter_6_digit_confirm_password = "Please enter 6 digit confirm mPIN"
    val password_not_match = "Both mPIN should be same."
    ...
    val yes = "Yes"
    val post_description_is_mandatory = "Job description is mandatory."
    val total_amount_is_mandatory = "Total amount is mandatory."
    val total_amount_should_be_more_than_0 = "Total amount should be more than"
    ...
    val enter_job_limit_amount = "Please enter amount less than"
    ...
    val call = "Call"
    val could_not_connect_server_message = "Could not connect to server. Try Again after some time."
}