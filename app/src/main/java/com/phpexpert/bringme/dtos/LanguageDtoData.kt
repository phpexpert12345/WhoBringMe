...
class LanguageDtoData {
    ...
    val save_amp_continue = "Save & Continue>"
    val history = "History"
    ...
    val receiver_time = "Receiver Time"
    ...
    val ok_text = "Ok"
    val password_must_contain_6_digits = "Password must contain 6 digits"
    val enter_register_mobile_text = "Please enter your registered mobile number."
    val otp_not_enter = "Otp not enter"
    val enter_new_password = "Enter new password"
    val enter_6_digit_password = "Please enter 6 digit password"
    val enter_confirm_password = "Enter Confirm password"
    val _enter_6_digit_confirm_password = "Please enter 6 digit confirm password"
    val password_not_match = "Password not match"
    ...
    val create_6_digit_password = "Please create a 6 digit password for account login."
    val must_contain_6_digit_password = "Password must contain only 6 digits."
    val job_view = "Job View"
    val subtotal = "Subtotal"
    val grand_total = "Grand Total"
    val maximum_characters_250 = "Maximum Characters : 250"
    ...
    val old_password = "Old Password"
    val please_enter_old_password_first = "Please Enter old password first"
    val please_enter_6_digit_old_password = "Please Enter 6 digit old password"
    val please_enter_new_password_first = "Please Enter new password first"
    val please_enter_6_digit_new_password = "Please Enter 6 digit new password"
    val please_enter_confirm_password_first = "Please Enter confirm password first"
    val please_enter_6_digit_confirm_password = "Please Enter 6 digit confirm password"
