...
import com.phpexpert.bringme.databinding.LayoutForgotPasswordThreeBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setAction() {
        loginBinding.loginButton.setOnClickListener {
            ...
            Handler().postDelayed({
                startActivity(Intent(this, com.phpexpert.bringme.activities.delivery.DashboardActivity::class.java))
                finishAffinity()
            }, 1000)
        }
